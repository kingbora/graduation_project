		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
					...
					html += '   <div class="upload_describtion">';
					html += '   	<div>';
					html += '			<label>标题：</label>';
					html += '			<input type="text" name="album_title" class="form-control" />';
					html += '		</div>';
					html += '   	<div>';
					html += '			<label>描述：</label>';
					html += '			<textarea name="album_describtion" class="form-control"></textarea>';
					html += '		</div>';
					html += '   </div>';

 ...
 */
var registerController = ['$scope','$timeout','$interval','registerService','AUTH_EVENTS','$window','$state', function($scope, $timeout, $interval, registerService, AUTH_EVENTS, $window, $state) {
